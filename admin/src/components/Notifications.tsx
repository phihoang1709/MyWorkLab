...
const Notifications = () => {
    return (
        <div className="mx-5 pt-2">
            ...
            <div id="dropdownNotification" className={`z-20 hidden right-10 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton`}>
